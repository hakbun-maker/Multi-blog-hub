...
> **TASKS.md는 반드시 `docs/planning/06-tasks.md`에 생성합니다!**
> **프로젝트 루트에 TASKS.md를 직접 생성하면 안 됩니다!**
...
**TASKS.md 생성 완료 후 AskUserQuestion 실행:**

```json
{
  "questions": [{
    "question": "docs/planning/06-tasks.md 생성이 완료되었습니다!\n\n다음 단계를 선택해주세요:",
    "header": "다음 단계",
    "options": [
