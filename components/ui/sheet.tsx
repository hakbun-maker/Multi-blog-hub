...
/**
 * shadcn/ui 스타일 Sheet — 우측에서 슬라이드해서 들어오는 패널.
 * Radix Dialog 위에 만든 가벼운 wrapper.
 */
  ...
  <SheetPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        // 우측 슬라이드
        side === 'right' && 'inset-y-0 right-0 h-full w-full sm:max-w-2xl border-l data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right',
